...
from utils_stream import load_and_prep_image, classes_and_models, update_logger, predict_json
from streamlit_yolov5 import predict
...
def make_prediction(image, model, class_names):
    ...
    pred_class = json_response["class_cat"]
    pred_conf = json_response["class_conf"]
...
choose_model = st.sidebar.selectbox(
    ...
    ("Model 1 (80 Coco classes)", # original 10 classes
...
# Model choice logic
if choose_model == "Model 1 (80 Coco classes)":
...
if not uploaded_file:
    ...
    #print("path of image",session_state.uploaded_image )
...
if session_state.pred_button:
    ...
    session_state.pred_conf = 100 #hardcoded
